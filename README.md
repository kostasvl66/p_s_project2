...
- Σχόλια:
	...
	- Στην παράλληλη εκτέλεση, ο πολλαπλασιασμός CSR-διανύσματος φέρνει χειρότερα αποτελέσματα απο την κοινή υλοποίηση. Η κοινή υλοποίηση λαμβάνει υψηλή επιτάχυνση μόλις εκτελεστεί με πολλαπλά νήματα, καθώς οι υπολογισμοί είναι απλοί, και η πρόσβαση στην μνήμη cache του επεξεργαστή από κάθε thread είναι αποτελεσματική. Αντιθέτως, στην CSR υλοποίηση κάθε νήμα δεν θα έχει ισότιμο αριθμό μη0μηδενικών τιμών να λάβει υπόψη του, άρα κάποια νήματα θα καθυστερήσουν την συνολική παράλληλη εκτέλεση λόγω υψηλότερου φόρτου. 
